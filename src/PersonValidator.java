...
public class PersonValidator {
    ...
    private static final Pattern DEPARTMENT_MASK = compile("^[a-zA-Zа-яА-Я]+\\sw*$");
    ...
    public static String validatePerson(Person person) {
        ...
        if (validatePhone(person.getDepartment()))
    ...
    public static boolean validateDepartment(String department) {
        return department != null && !department.isEmpty() && PHONE_MASK.matcher(department).matches();
